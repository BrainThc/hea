<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\project\www\view\admin\app\public/../application/index\view\index\login.html";i:1568621898;}*/ ?>
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-xs5">
                    <div style="margin-left: 10px;">
                        <img onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random()" src="<?php echo captcha_src(); ?>" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode">
                    </div>
                </div>
            </div>
        </div>
