<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\project\www\view\admin\app\public/../application/index\view\index\home.html";i:1546914855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="console">
                  <a lay-href="/merchant/merchant/list.html">商户列表</a>
                </dd>

                <dd data-name="sell" class="layui-nav-itemed">
                  <a lay-href="/depot/purchase/list.html">商户门店</a>
                </dd>
            ...
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="form" class="layui-nav-itemed">
